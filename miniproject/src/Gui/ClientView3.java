...
public class ClientView3 extends JFrame implements ActionListener, MouseListener {
	...
	public ClientView3() {
		...
		storename = new JLabel("다인네 반찬");
		imageicon = new ImageIcon("food23.jpg");
		imageicon2 = new ImageIcon("food24.jpg");
		imageicon3= new ImageIcon("food25.jpg");
		imageicon4 = new ImageIcon("food26.jpg");
		imageicon5 = new ImageIcon("food27.jpg");
		imageicon6 = new ImageIcon("food31.jpg");
		imageicon7 = new ImageIcon("food29.jpg");
		imageicon8 = new ImageIcon("food30.jpg");
		...
		Object[][] contents = { 
				{ "잡채", "5500", imageicon }, 
				{ "떡볶이", "4000", imageicon2}, 
				{ "계란말이", "3500", imageicon3 },
				{ "김밥", "2000", imageicon4 },
				{ "고구마강정", "2500", imageicon5 },
				{ "장조림", "4000", imageicon6 },
				{ "오무라이스", "4500", imageicon7 },
				{ "짜장", "4000", imageicon8 }
